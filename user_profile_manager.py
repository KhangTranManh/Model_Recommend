...
class UserProfileManager:
    ...
    def __init__(self, profiles_dir=None):
        self.profiles_dir = profiles_dir or config.data_dir_path
        self.profiles_json_path = os.path.join(self.profiles_dir, 'user_profiles.json')
        self.profiles_npz_path = os.path.join(self.profiles_dir, 'user_profiles.npz')
