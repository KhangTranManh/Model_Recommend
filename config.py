...
class Config:
    ...
    CHECKPOINT_BEST = PROJECT_ROOT / "fashion_clip_best.pt"
    CHECKPOINT_FINAL = PROJECT_ROOT / "fashion_clip_final.pt"
    
    # Data files (in project root)
    GALLERY_EMBEDDINGS = PROJECT_ROOT / "gallery_embeddings.npz" 
    GALLERY_INDEX = PROJECT_ROOT / "gallery_ip.index"
    USER_HISTORY = PROJECT_ROOT / "user_history.json"
    GLOBAL_STATS = PROJECT_ROOT / "global_stats.json"
    
    # Directories
    IMAGES_DIR = PROJECT_ROOT / "pic"
